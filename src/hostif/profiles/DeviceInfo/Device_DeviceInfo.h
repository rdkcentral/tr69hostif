...
//#define LOG_UPLOAD_SCR	"backgroundrun /usr/bin/logupload "" 1 1 false HTTPS "" ondemand false "" "
#define LOG_UPLOAD_SCR "backgroundrun /usr/bin/logupload uploadlogsnow >> /opt/logs/rdm_status.log 2>&1"
