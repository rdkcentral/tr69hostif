...
static int read_Device_Ethernet_Interface_Stats_Fields(unsigned int ethInterfaceNum, EEthInterfaceStatsMembers ethInterfaceStatMem)
{
    ...
    {
    case eBytesSent:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/tx_bytes",ethName);
    ...
    case eBytesReceived:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/rx_bytes",ethName);
    ...
    case eBroadcastPacketsSent:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/tx_packets",ethName);
    ...
    case eBroadcastPacketsReceived:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/rx_packets",ethName);
    ...
    case eErrorsSent:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/tx_errors",ethName);
    ...
    case eErrorsReceived:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/rx_errors",ethName);
    ...
    case eDiscardPacketsSent:
        snprintf(cmd,BUFF_LENGTH,"cat /sys/class/net/%s/statistics/tx_dropped",ethName);
    ...
    case eUnknownProtoPacketsReceived:
        snprintf(cmd,BUFF_LENGTH, "cat /sys/class/net/%s/statistics/rx_dropped",ethName);
